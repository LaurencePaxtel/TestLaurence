...
$kk:=Get last field number:C255(->[LesCentres:9])
ARRAY TEXT:C222(ta_Champs; $kk)
ARRAY POINTER:C280(tp_Champs; $kk)
ARRAY INTEGER:C220(te_ChampsType; $kk)
For ($ii; 1; $kk)
	ta_Champs{$ii}:=Substring:C12(Field name:C257(Table:C252(->[LesCentres:9]); $ii); 4)
	tp_Champs{$ii}:=Field:C253(Table:C252(->[LesCentres:9]); $ii)
...
FORM SET OUTPUT:C54([LesCentres:9]; "V_Développeur")
ALL RECORDS:C47([LesCentres:9])
MultiSoc_Filter(->[LesCentres:9])
vL_Nb_HG_F:=Records in selection:C76([LesCentres:9])
FIRST RECORD:C50([HeberGement:5])
If (<>vl_EcranL>(1171+15))
	$vl_EcranL:=(1171+15)
Else 
