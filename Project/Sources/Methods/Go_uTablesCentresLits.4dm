...
//{ © DBsolutions/Paxtel
//{
//{          Procédure : Go_uTablesCentresLits
//{
...
$kk:=Get last field number:C255(->[CentresLits:16])
ARRAY TEXT:C222(ta_Champs; $kk)
ARRAY POINTER:C280(tp_Champs; $kk)
ARRAY INTEGER:C220(te_ChampsType; $kk)
For ($ii; 1; $kk)
	ta_Champs{$ii}:=Substring:C12(Field name:C257(Table:C252(->[CentresLits:16]); $ii); 4)
	tp_Champs{$ii}:=Field:C253(Table:C252(->[CentresLits:16]); $ii)
...
va_Titre:="Liste des centres : "
READ ONLY:C145([CentresLits:16])
FORM SET OUTPUT:C54([CentresLits:16]; "V_Développeur")
ALL RECORDS:C47([CentresLits:16])
MultiSoc_Filter(->[CentresLits:16])
vL_Nb_HG_F:=Records in selection:C76([CentresLits:16])
...
DISPLAY SELECTION:C59([CentresLits:16]; *)
