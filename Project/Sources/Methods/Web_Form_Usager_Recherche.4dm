...
// ----------------------------------------------------
// Méthode : Web_Form_Usager_Recherche
// Description
// 
//
// Paramètres
...
C_TEXT:C284(class_invalid_password; class_invalid_email; class_invalid_first_name; class_invalid_last_name; class_invalid_communication; class_invalid_email; class_invalid_lien_famille)
...
$TB_HTML{$o}{6}:="nom"
$TB_HTML{$o}{7}:="span7 search fdp_placeholder fdp_row_start iw_data_column_2 "+$disabled+" "+class_invalid_last_name
...
$TB_HTML{$o}{6}:="prenom"
$TB_HTML{$o}{7}:="span7 search fdp_placeholder iw_data_column_3 "+$disabled+" "+class_invalid_first_name
...
$TB_HTML{$o}{7}:="fdp_span3 datepicker span7  iw_data_column_4 "
...
$TB_HTML{$o}{7}:="span7 search fdp_placeholder fdp_row_start  iw_data_column_6 "+$disabled+" "+class_invalid_lien_famille
...
$TB_HTML{$o}{7}:="span7 search fdp_placeholder  iw_data_column_6 "+$disabled+" "+class_invalid_first_name
...
$TB_HTML{$o}{1}:="input"
$TB_HTML{$o}{2}:="hidden"
$TB_HTML{$o}{3}:="search_type"
$TB_HTML{$o}{4}:=""
$TB_HTML{$o}{5}:=""
$TB_HTML{$o}{6}:="search_type"
$TB_HTML{$o}{7}:="iw_data_column_5"

$o:=$o+1
$TB_HTML{$o}{1}:="input"
$TB_HTML{$o}{2}:="hidden"
$TB_HTML{$o}{3}:="display_type"
$TB_HTML{$o}{4}:=""
$TB_HTML{$o}{5}:=""
$TB_HTML{$o}{6}:="display_type"
$TB_HTML{$o}{7}:="iw_data_column_8"
