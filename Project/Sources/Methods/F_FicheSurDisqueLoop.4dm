...
//{ LOGICIEL : SSP
//{ © DBsolutions
//{          Procédure : F_FicheSurDisqueLoop
...
If (Records in selection:C76([HeberGement:5])=1)
	...
	If ($vb_OK)
		$vb_Ok:=F_FicheSurDisqueLoopFichier(->vt_TitreDocument; vd_DateRéelle; vd_HeureRéelle; <>va_T_Site; [HeberGement:5]HG_FicheNuméro:3; [HeberGement:5]HG_EtatCivil:20; [HeberGement:5]HG_Age:23)
		If ($vb_OK)
	...
	If ($vb_OK)
		...
		If (OK=1)
			...
			$vb_Ok:=F_FicheSurDisqueData($h_RefDoc; vd_DateRéelle; vd_HeureRéelle; 8; $4; $5)  //8 pour STR de l'Ecran ASILE
