...
$T_Window_titre:="Dossier Infirmier"

F_LesOrientes(-1)
F_LesOrientes(0)

READ WRITE:C146([DePart:1])
FORM SET INPUT:C55([DePart:1]; "DP_DosInfirmier")
va_Titre:="Dossier infirmier"
//$vl_Fenetre:=i_FenêtreNo (786;508;4;va_Titre;1;"Quit_Show")
$vl_Fenetre:=FEN_OpenFormWindow(->[DePart:1]; "DP_DosInfirmier"; Form fenêtre standard:K39:10; $T_Window_titre)
