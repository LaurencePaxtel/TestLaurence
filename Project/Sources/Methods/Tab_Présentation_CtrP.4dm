...
Case of 
	...
	: ($1=2)  //Chargement des données
		...
		QUERY:C277([PreSentation:44]; [PreSentation:44]PS_Catégorie:3=<>ta_ItemGroupe{3}; *)
		...
		QUERY:C277([PreSentation:44];  & ; [PreSentation:44]PS_LibelléOrigneID:6=0)
		MultiSoc_Filter(->[PreSentation:44])
		vl_NbPrestaGpe:=Records in selection:C76([PreSentation:44])
		ORDER BY:C49([PreSentation:44]; [PreSentation:44]PS_Libellé:4; >)
		SELECTION TO ARRAY:C260([PreSentation:44]PS_RéférenceID:1; tl_yCtreP_Réf; [PreSentation:44]PS_Catégorie:3; ta_yCtreP_Réf; [PreSentation:44]PS_Libellé:4; ta_yCtreP; [PreSentation:44]PS_Ordre:7; te_yCtreP_Ordre; [PreSentation:44]PS_Diviseur:9; te_yCtreP_Div)
		...
		QUERY:C277([PreSentation:44];  & ; [PreSentation:44]PS_LibelléOrigneID:6>0)
		MultiSoc_Filter(->[PreSentation:44])
		vl_NbPrestaNA:=Records in selection:C76([PreSentation:44])
		ORDER BY:C49([PreSentation:44]; [PreSentation:44]PS_Libellé:4; >)
		SELECTION TO ARRAY:C260([PreSentation:44]PS_RéférenceID:1; tl_FileCtreP_Réf; [PreSentation:44]PS_Catégorie:3; ta_FileCtreP_Réf; [PreSentation:44]PS_Libellé:4; ta_FileCtreP; [PreSentation:44]PS_LibelléOrigine:5; ta_FilexCtreP; [PreSentation:44]PS_LibelléOrigneID:6; tl_FilexCtreP_Réf; [PreSentation:44]PS_Ordre:7; te_FileCtreP_Ordre; [PreSentation:44]PS_Etat:8; te_FileCtreP_Etat; [PreSentation:44]PS_Diviseur:9; te_FileCtreP_Div)
		
		Tab_Présentation_CtrP(3; 0; 1)  //Relié ou pas
		Tab_Présentation_CtrP(3; 0; 2)  //Nombre de prestations reliés
		...
		Tab_Présentation_CtrP(1; $ii; 1)  //Synchroniser       
		Tab_Présentation_CtrP(4; $ii; 1)  //Clic dans le tableau de gauche
	...
	: ($1=6)  //Tableaux : Affecter
		...
		Case of 
			: ($3=1)
			: ($3=2)
				tl_yCtreP_Réf{$ii}:=[PreSentation:44]PS_RéférenceID:1
				ta_yCtreP_Réf{$ii}:=[PreSentation:44]PS_Catégorie:3
				ta_yCtreP{$ii}:=[PreSentation:44]PS_Libellé:4
				te_yCtreP_Ordre{$ii}:=[PreSentation:44]PS_Ordre:7
				te_yCtreP_Etat{$ii}:=[PreSentation:44]PS_Etat:8
				te_yCtreP_Div{$ii}:=[PreSentation:44]PS_Diviseur:9
				te_yCtreP_Check{$ii}:=0
			: ($3=3)
				tl_FileCtreP_Réf{$ii}:=[PreSentation:44]PS_RéférenceID:1
				ta_FileCtreP_Réf{$ii}:=[PreSentation:44]PS_Catégorie:3
				ta_FileCtreP{$ii}:=[PreSentation:44]PS_Libellé:4
				ta_FilexCtreP{$ii}:=[PreSentation:44]PS_LibelléOrigine:5
				tl_FilexCtreP_Réf{$ii}:=[PreSentation:44]PS_LibelléOrigneID:6
				te_FileCtreP_Ordre{$ii}:=[PreSentation:44]PS_Ordre:7
				te_FileCtreP_Etat{$ii}:=[PreSentation:44]PS_Etat:8
				te_FileCtreP_Div{$ii}:=[PreSentation:44]PS_Diviseur:9
		End case 
	...
	: ($1=7)  //Tableaux : Affecter plusieurs lignes  :synchro apres modif
		...
		For ($ii; 1; Size of array:C274(tl_FileCtreP_Réf))
			If (ta_FileCtreP{$ii}=va_LibEnum)
				...
				QUERY:C277([PreSentation:44]; [PreSentation:44]PS_RéférenceID:1=tl_FileCtreP_Réf{$ii})
				MultiSoc_Filter(->[PreSentation:44])
				If (Records in selection:C76([PreSentation:44])=1)
					Repeat 
						LOAD RECORD:C52([PreSentation:44])
					Until (Not:C34(Locked:C147([PreSentation:44])))
					[PreSentation:44]PS_Libellé:4:=ta_FileCtreP{$ii}
					[PreSentation:44]PS_Ordre:7:=te_FileCtreP_Ordre{$ii}
					[PreSentation:44]PS_Diviseur:9:=te_FileCtreP_Div{$ii}
		...
		If ($vb_OK)
			...
			If ($ii>0)
				If (i_Confirmer(ta_xCtreP{$2}+" est déjà rattaché à : "+ta_FileCtreP{$ii}+<>va_CR+"Veuillez confirmer le transfert ?"))
					...
					Tab_Présentation_CtrP(22; $2; $3)  //Modifier la liaison
				End if 
			Else   //Pas de lien
				Tab_Présentation_CtrP(21; $2; $3)
			End if 
		End if 
	...
	: ($1=21)  //Effectuer la liaison
		...
		[PreSentation:44]PS_Libellé:4:=ta_yCtreP{$3}
		[PreSentation:44]PS_LibelléOrigine:5:=ta_xCtreP{$2}
		[PreSentation:44]PS_LibelléOrigneID:6:=tl_xCtreP_ID{$2}
		[PreSentation:44]PS_Ordre:7:=te_yCtreP_Ordre{$3}
		[PreSentation:44]PS_Etat:8:=0
		[PreSentation:44]PS_Diviseur:9:=te_yCtreP_Div{$3}
		SAVE RECORD:C53([PreSentation:44])
		Tab_Présentation_CtrP(5; 0; 3)
		$ii:=Size of array:C274(tl_FileCtreP_Réf)
		Tab_Présentation_CtrP(6; $ii; 3)
		UNLOAD RECORD:C212([PreSentation:44])
		READ ONLY:C145([PreSentation:44])
		//Tab_Présentation_CtrP (3;0;1)
		te_xCtreP{$2}:=1  //Signe Plus de la liaison activée 		
		te_xCtreP_Etat{$2}:=1  //Signe X de l'existance de la laison 
		Tab_Présentation_CtrP(3; 0; 2)
		Tab_Présentation_CtrP(4; $2; 1)
	...
	: ($1=22)  //Modifier la liaison
		...
		If (Records in selection:C76([PreSentation:44])=1)
			...
			Until (Not:C34(Locked:C147([PreSentation:44])))
			[PreSentation:44]PS_Libellé:4:=ta_yCtreP{$3}
			//[PreSentation]PS_LibelléOrigine:=ta_xCtreP{$2}
			//[PreSentation]PS_LibelléOrigneID:=tl_xCtreP_ID{$2}
			[PreSentation:44]PS_Ordre:7:=te_yCtreP_Ordre{$3}
			[PreSentation:44]PS_Etat:8:=0
			[PreSentation:44]PS_Diviseur:9:=te_yCtreP_Div{$3}
			SAVE RECORD:C53([PreSentation:44])
	...
	: ($1=40)  //Ajouter une fiche dans la table
		...
		If (OK=1)
			...
			//Tab_Présentation_CtrP (6;Taille tableau(tl_FileCtreP_Réf);3)
			
			//Nouvelle ligne dans le tableau de droite
			Tab_Présentation_CtrP(5; 0; 2)
			//Affecter le tableau de droite
			Tab_Présentation_CtrP(6; Size of array:C274(tl_yCtreP_Réf); 2)
			
			Tab_Présentation_CtrP(1; ta_xCtreP; 1)  //Synchroniser     
			Tab_Présentation_CtrP(4; ta_xCtreP; 1)  //Clic dans le tableau de gauche  
			Tab_Présentation_CtrP(1; Size of array:C274(tl_yCtreP_Réf); 2)  //Synchroniser     
			Tab_Présentation_CtrP(4; Size of array:C274(tl_yCtreP_Réf); 2)  //Clic dans le tableau de droite  
	...
	: ($1=50)  //Modifier une fiche dans la table
		...
		If ($vb_OK)
			READ WRITE:C146([PreSentation:44])
			QUERY:C277([PreSentation:44]; [PreSentation:44]PS_RéférenceID:1=tl_yCtreP_Réf{ta_yCtreP})
			MultiSoc_Filter(->[PreSentation:44])
			If (Records in selection:C76([PreSentation:44])=1)
				va_LibEnum:=""
				FORM SET INPUT:C55([PreSentation:44]; "PS_EcranSaisie")
				...
				If (OK=1)
					...
					Tab_Présentation_CtrP(6; ta_yCtreP; 2)
					//Modifications générales du libellé de l'item de regroupement
					Tab_Présentation_CtrP(7; ta_yCtreP; 2)
				End if 
				UNLOAD RECORD:C212([PreSentation:44])
				CLOSE WINDOW:C154($vl_Fenetre)
			End if 
	...
	: ($1=60)  //Supprimer une fiche dans la table
		...
		If ($vb_OK)
			If (i_Confirmer("Confirmez-vous la suppression de l'item : "+ta_yCtreP{$3}))
				...
				Tab_Présentation_CtrP(8; $3; 2)
				//Synchroniser l'ensemble
				vl_NbPrestaGpe:=Size of array:C274(tl_yCtreP_Réf)
				If ($3>vl_NbPrestaGpe)
					$3:=vl_NbPrestaGpe
				End if 
				Tab_Présentation_CtrP(1; $3; 2)
				Tab_Présentation_CtrP(4; $3; 2)
				Tab_Présentation_CtrP(3; $2; 1)
				Tab_Présentation_CtrP(3; $3; 2)
			End if 
		End if 
		...
		Case of 
			...
			: (Size of array:C274(ta_yCtreP)>0)
				...
				For ($ii; 1; Size of array:C274(ta_yCtreP))
					QUERY:C277([PreSentation:44]; [PreSentation:44]PS_Catégorie:3=<>ta_ItemGroupe{3}; *)
					QUERY:C277([PreSentation:44];  & ; [PreSentation:44]PS_Scénario:2=va_LibScénario; *)
					QUERY:C277([PreSentation:44];  & ; [PreSentation:44]PS_Libellé:4=ta_yCtreP{$ii})
					MultiSoc_Filter(->[PreSentation:44])
					If (Records in selection:C76([PreSentation:44])>0)
