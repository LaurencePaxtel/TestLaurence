...
Else 
	SELECTION TO ARRAY:C260($field_id->; $tb_id; $field_value->; $tb_value; $field_value_second->; $tb_value_second)
	
	For ($i; 1; $size)
		OB SET:C1220($tb_result{$i}; "id"; $tb_id{$i}; "value"; $tb_value{$i}+" "+$tb_value_second{$i})
	End for 
