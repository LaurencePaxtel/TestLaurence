...
//{ © DBsolutions/Paxtel
//{
//{          Procédure : Go_StatTrancheContinue
//{
//{          Lundi 28 juin 2010 à 10:30:00
//{          Modifiée :
...
va_Titre:="Statistiques : Supervision  durée de prise en charge"
...
//••• Tranches
P_LesTranchesNuitees(0; "Hébergements sans interruption")
...
FORM SET INPUT:C55([DiaLogues:3]; "DL_StatTranchesContinues")
C_LONGINT:C283($vl_Fenetre)
If (va_CasSupervision="Anonyme")
	$vl_Fenetre:=i_FenêtreNo(1024; 330; 4; va_Titre; 1; "Quit_Show")
Else 
