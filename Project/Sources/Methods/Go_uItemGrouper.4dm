...
Tab_ItemGrouper_EtCv(0; 0; 0)
Tab_ItemGrouper_EtCv(2; 0; 0)

Tab_ItemGrouper_CtrH(0; 0; 0)
Tab_ItemGrouper_CtrH(2; 0; 0)

Tab_ItemGrouper_CtrP(0; 0; 0)
Tab_ItemGrouper_CtrP(2; 0; 0)

va_Titre:="Regroupement d'items"
$vl_Fenetre:=i_FenêtreNo(816; 588; 16; va_Titre; 1; "Quit_Simple")  //876
FORM SET INPUT:C55([DePart:1]; "DP_ItemGrouper")
