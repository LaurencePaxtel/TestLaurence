...
$kk:=Get last field number:C255(->[Maraude:24])
ARRAY TEXT:C222(ta_Champs; $kk)
ARRAY POINTER:C280(tp_Champs; $kk)
ARRAY INTEGER:C220(te_ChampsType; $kk)
For ($ii; 1; $kk)
	ta_Champs{$ii}:=Substring:C12(Field name:C257(Table:C252(->[Maraude:24]); $ii); 4)
...
va_Titre:="Liste des maraudes : "
READ ONLY:C145([Maraude:24])
FORM SET OUTPUT:C54([Maraude:24]; "V_Développeur")
ALL RECORDS:C47([Maraude:24])
MultiSoc_Filter(->[Maraude:24])
vL_Nb_HG_F:=Records in selection:C76([Maraude:24])
...
DISPLAY SELECTION:C59([Maraude:24]; *)
