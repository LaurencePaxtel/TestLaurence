...
If (OK=1)
	...
	If (Records in selection:C76([DePart:1])>0)
		...
		FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_GIP1s")
		PRINT SELECTION:C60([DePart:1]; *)
		FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_GIP2s")
		PRINT SELECTION:C60([DePart:1]; *)
		FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_GIP3s")
		PRINT SELECTION:C60([DePart:1]; *)
		FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_Assocs")
		PRINT SELECTION:C60([DePart:1]; *)
		FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_Appels")
		PRINT SELECTION:C60([DePart:1]; *)
		
		FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_GIP1n")
		PRINT SELECTION:C60([DePart:1]; *)
		FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_GIP2n")
		PRINT SELECTION:C60([DePart:1]; *)
		FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_GIP3n")
		PRINT SELECTION:C60([DePart:1]; *)
