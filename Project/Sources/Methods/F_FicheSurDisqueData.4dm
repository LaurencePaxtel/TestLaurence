...
//{ LOGICIEL : SSP
//{ © DBsolutions
//{          Fonction : F_FicheSurDisqueData
//{          Vendredi 29 avril 2011 à 15:20
//{          Modifiée :
...
C_LONGINT:C283($6)  //Export type (0 : report; 1=Prestations)
...
$vt_Block:=$vt_Block+"Infos : "+<>va_Tab+<>va_T_Site+", Le "+String:C10($2; Interne date court:K1:7)+" à "+String:C10($3; h mn s:K7:1)+<>va_Tab+String:C10($vl_ExportType)+<>va_Tab+"0"+<>va_CR
