...
// Date and time : 06/06/2020, 07:55:29
// ----------------------------------------------------
// Method: Web_GL_Get_Stock_TS
// Description
// 
//
// Parameters
...
//APPEND TO ARRAY($tb_headers_values;->[Equipement]ID)
...
APPEND TO ARRAY:C911($tb_headers_values; ->[Stock:113]STK_Stock:4)
APPEND TO ARRAY:C911($tb_headers_values; ->[Stock:113]STK_Stock_Reserve:6)
APPEND TO ARRAY:C911($tb_headers_values; ->[Stock:113]STK_Stock_Disponible:5)
//APPEND TO ARRAY($tb_headers_values;->[Stock]STK_Emplacement)
...
If ($search_filtre_0#"")
	QUERY SELECTION:C341([Equipement:107]; [Equipement:107]EQU_Nom:4="@"+$search_filtre_0+"@")
End if 

If ($search_filtre_1#"")
	QUERY SELECTION:C341([Equipement:107]; [Equipement:107]EQU_Type:5="@"+$search_filtre_1+"@")
End if 
...
For ($k; $page_start; $records_counter)
	...
	For ($j; 1; Size of array:C274($tb_headers_th))
		...
		Case of 
			...
			Else 
				$JSON:=$JSON+"\""+$tb_headers_th{$j}+"\":\"<div id='"+String:C10([Equipement:107]ID:1)+"'>"+String:C10($tb_headers_values{$j}->)+"</div>\""
		End case 
