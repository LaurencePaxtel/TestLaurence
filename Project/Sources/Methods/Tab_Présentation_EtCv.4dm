...
//{ © DBsolutions/Paxtel
//{
//{          Procédure : Tab_Présentation_EtCv
//{
...
Case of 
	...
	: ($1=2)  //Chargement des données
		...
		//Le champ :[PreSentation]PS_LibelléOrigneID=0 pour les items de regroupement
		//Le champ :[PreSentation]PS_LibelléOrigneID=1 pour tous les liens
		vl_NbEtCvGpe:=Records in selection:C76([PreSentation:44])
		ORDER BY:C49([PreSentation:44]; [PreSentation:44]PS_Libellé:4; >)
		SELECTION TO ARRAY:C260([PreSentation:44]PS_RéférenceID:1; tl_yEtCiv_Réf; [PreSentation:44]PS_Catégorie:3; ta_yEtCiv_Réf; [PreSentation:44]PS_Libellé:4; ta_yEtCiv; [PreSentation:44]PS_Ordre:7; te_yEtCiv_Ordre; [PreSentation:44]PS_Diviseur:9; te_yEtCiv_Div)
		...
		QUERY:C277([PreSentation:44];  & ; [PreSentation:44]PS_LibelléOrigneID:6>0)
		MultiSoc_Filter(->[PreSentation:44])
		vl_NbEtCvNA:=Records in selection:C76([PreSentation:44])
		ORDER BY:C49([PreSentation:44]; [PreSentation:44]PS_Libellé:4; >)
		SELECTION TO ARRAY:C260([PreSentation:44]PS_RéférenceID:1; tl_FileEtCiv_Réf; [PreSentation:44]PS_Catégorie:3; ta_FileEtCiv_Réf; [PreSentation:44]PS_Libellé:4; ta_FileEtCiv; [PreSentation:44]PS_LibelléOrigine:5; ta_FilexEtCiv; [PreSentation:44]PS_LibelléOrigneID:6; tl_FilexEtCiv_Réf; [PreSentation:44]PS_Ordre:7; te_FileEtCiv_Ordre; [PreSentation:44]PS_Etat:8; te_FileEtCiv_Etat; [PreSentation:44]PS_Diviseur:9; te_FileEtCiv_Div)
		
		Tab_Présentation_EtCv(3; 0; 1)  //Relié ou pas
		
		Tab_Présentation_EtCv(3; 0; 2)  //Nombre d'états civils reliés
		...
		Else 
			$ii:=0
		End if 
		Tab_Présentation_EtCv(1; $ii; 1)  //Synchroniser       
		Tab_Présentation_EtCv(4; $ii; 1)  //Clic dans le tableau de gauche
	...
	: ($1=6)  //Tableaux : Affecter
		...
		Case of 
			: ($3=1)
			: ($3=2)
				tl_yEtCiv_Réf{$ii}:=[PreSentation:44]PS_RéférenceID:1
				ta_yEtCiv_Réf{$ii}:=[PreSentation:44]PS_Catégorie:3
				ta_yEtCiv{$ii}:=[PreSentation:44]PS_Libellé:4
				te_yEtCiv_Ordre{$ii}:=[PreSentation:44]PS_Ordre:7
				te_yEtCiv_Etat{$ii}:=[PreSentation:44]PS_Etat:8
				te_yEtCiv_Div{$ii}:=[PreSentation:44]PS_Diviseur:9
				te_yEtCiv_Check{$ii}:=0
			: ($3=3)
				tl_FileEtCiv_Réf{$ii}:=[PreSentation:44]PS_RéférenceID:1
				ta_FileEtCiv_Réf{$ii}:=[PreSentation:44]PS_Catégorie:3
				ta_FileEtCiv{$ii}:=[PreSentation:44]PS_Libellé:4
				ta_FilexEtCiv{$ii}:=[PreSentation:44]PS_LibelléOrigine:5
				tl_FilexEtCiv_Réf{$ii}:=[PreSentation:44]PS_LibelléOrigneID:6
				te_FileEtCiv_Ordre{$ii}:=[PreSentation:44]PS_Ordre:7
				te_FileEtCiv_Etat{$ii}:=[PreSentation:44]PS_Etat:8
				te_FileEtCiv_Div{$ii}:=[PreSentation:44]PS_Diviseur:9
		End case 
	...
	: ($1=7)  //Tableaux : Affecter plusieurs lignes  :synchro apres modif
		...
		For ($ii; 1; Size of array:C274(tl_FileEtCiv_Réf))
			If (ta_FileEtCiv{$ii}=va_LibEnum)
				...
				QUERY:C277([PreSentation:44]; [PreSentation:44]PS_Scénario:2=tl_FileEtCiv_Réf{$ii})
				MultiSoc_Filter(->[PreSentation:44])
				If (Records in selection:C76([PreSentation:44])=1)
					Repeat 
						LOAD RECORD:C52([PreSentation:44])
					Until (Not:C34(Locked:C147([PreSentation:44])))
					[PreSentation:44]PS_Libellé:4:=ta_FileEtCiv{$ii}
					[PreSentation:44]PS_Ordre:7:=te_FileEtCiv_Ordre{$ii}
					[PreSentation:44]PS_Diviseur:9:=te_FileEtCiv_Div{$ii}
		...
		If ($vb_OK)
			...
			If ($ii>0)
				If (i_Confirmer(ta_xEtCiv{$2}+" est déjà rattaché à : "+ta_FileEtCiv{$ii}+<>va_CR+"Veuillez confirmer le transfert ?"))
					...
					Tab_Présentation_EtCv(22; $2; $3)  //Modifier la liaison
				End if 
			Else   //Pas de lien
				Tab_Présentation_EtCv(21; $2; $3)
			End if 
		End if 
	...
	: ($1=21)  //Effectuer la liaison
		...
		[PreSentation:44]PS_Libellé:4:=ta_yEtCiv{$3}
		[PreSentation:44]PS_LibelléOrigine:5:=ta_xEtCiv{$2}
		[PreSentation:44]PS_LibelléOrigneID:6:=1
		[PreSentation:44]PS_Ordre:7:=te_yEtCiv_Ordre{$3}
		[PreSentation:44]PS_Etat:8:=0
		[PreSentation:44]PS_Diviseur:9:=te_yEtCiv_Div{$3}
		SAVE RECORD:C53([PreSentation:44])
		Tab_Présentation_EtCv(5; 0; 3)
		$ii:=Size of array:C274(tl_FileEtCiv_Réf)
		Tab_Présentation_EtCv(6; $ii; 3)
		UNLOAD RECORD:C212([PreSentation:44])
		READ ONLY:C145([PreSentation:44])
		//Tab_Présentation_EtCv (3;0;1)
		te_xEtCiv{$2}:=1  //Signe Plus de la liaison activée 		
		te_xEtCiv_Etat{$2}:=1  //Signe X de l'existance de la laison 
		Tab_Présentation_EtCv(3; 0; 2)
		Tab_Présentation_EtCv(4; $2; 1)
		
	: ($1=22)  //Modifier la liaison
		i_Message("Mise à jour en cours…")
		$ii:=Find in array:C230(ta_FilexEtCiv; ta_xEtCiv{$2})
		READ WRITE:C146([PreSentation:44])
		QUERY:C277([PreSentation:44]; [PreSentation:44]PS_RéférenceID:1=tl_FileEtCiv_Réf{$ii})
		MultiSoc_Filter(->[PreSentation:44])
		If (Records in selection:C76([PreSentation:44])=1)
			Repeat 
				LOAD RECORD:C52([PreSentation:44])
			Until (Not:C34(Locked:C147([PreSentation:44])))
			[PreSentation:44]PS_Libellé:4:=ta_yEtCiv{$3}
			//[PreSentation]PS_LibelléOrigine:=ta_xEtCiv{$2}
			//[PreSentation]PS_LibelléOrigneID:=1
			[PreSentation:44]PS_Ordre:7:=te_yEtCiv_Ordre{$3}
			[PreSentation:44]PS_Diviseur:9:=0
			[PreSentation:44]PS_Diviseur:9:=te_yEtCiv_Div{$3}
			SAVE RECORD:C53([PreSentation:44])
			UNLOAD RECORD:C212([PreSentation:44])
	...
	: ($1=40)  //Ajouter une fiche dans la table
		...
		If (OK=1)
			...
			//Tab_Présentation_EtCv (6;Taille tableau(tl_FileEtCiv_Réf);3)
			
			//Nouvelle ligne dans le tableau de droite
			Tab_Présentation_EtCv(5; 0; 2)
			//Affecter le tableau de droite
			Tab_Présentation_EtCv(6; Size of array:C274(tl_yEtCiv_Réf); 2)
			
			Tab_Présentation_EtCv(1; ta_xEtCiv; 1)  //Synchroniser     
			Tab_Présentation_EtCv(4; ta_xEtCiv; 1)  //Clic dans le tableau de gauche  
			Tab_Présentation_EtCv(1; Size of array:C274(tl_yEtCiv_Réf); 2)  //Synchroniser     
			Tab_Présentation_EtCv(4; Size of array:C274(tl_yEtCiv_Réf); 2)  //Clic dans le tableau de droite  
	...
	: ($1=50)  //Modifier une fiche dans la table
		...
		If ($vb_OK)
			READ WRITE:C146([PreSentation:44])
			QUERY:C277([PreSentation:44]; [PreSentation:44]PS_RéférenceID:1=tl_yEtCiv_Réf{ta_yEtCiv})
			MultiSoc_Filter(->[PreSentation:44])
			If (Records in selection:C76([PreSentation:44])=1)
				va_LibEnum:=""
				FORM SET INPUT:C55([PreSentation:44]; "PS_EcranSaisie")
				...
				If (OK=1)
					...
					Tab_Présentation_EtCv(6; ta_yEtCiv; 2)
					//Modifications générales du libellé de l'item de regroupement
					Tab_Présentation_EtCv(7; ta_yEtCiv; 2)
				End if 
				UNLOAD RECORD:C212([PreSentation:44])
				CLOSE WINDOW:C154($vl_Fenetre)
			End if 
	...
	: ($1=60)  //Supprimer une fiche dans la table
		...
		If ($vb_OK)
			If (i_Confirmer("Confirmez-vous la suppression de l'item : "+ta_yEtCiv{$3}))
				...
				Tab_Présentation_EtCv(8; $3; 2)
				//Synchroniser l'ensemble
				vl_NbEtCvGpe:=Size of array:C274(tl_yEtCiv_Réf)
				If ($3>vl_NbEtCvGpe)
					$3:=vl_NbEtCvGpe
				End if 
				Tab_Présentation_EtCv(1; $3; 2)
				Tab_Présentation_EtCv(4; $3; 2)
				Tab_Présentation_EtCv(3; $2; 1)
				Tab_Présentation_EtCv(3; $3; 2)
			End if 
		End if 
			...
			: (Size of array:C274(ta_yEtCiv)>0)
				...
				If (Records in selection:C76([PreSentation:44])>0)
					...
					For ($ii; 1; Size of array:C274(ta_yEtCiv))
						QUERY:C277([PreSentation:44]; [PreSentation:44]PS_Catégorie:3=<>ta_ItemGroupe{1}; *)
						QUERY:C277([PreSentation:44];  & ; [PreSentation:44]PS_Scénario:2=va_LibScénario; *)
						QUERY:C277([PreSentation:44];  & ; [PreSentation:44]PS_LibelléOrigine:5=ta_yEtCiv{$ii})
						MultiSoc_Filter(->[PreSentation:44])
						If (Records in selection:C76([PreSentation:44])>0)
