...
If ($5)
	...
	SEND PACKET:C103($1; _O_Mac to Win:C463("Infos : "+<>va_Tab+<>va_T_Site+", Le "+String:C10($2; Interne date court:K1:7)+" à "+String:C10($3; h mn s:K7:1)+<>va_Tab+String:C10($ve_ExportType)+<>va_Tab+"0")+<>va_CR)
	...
	SEND PACKET:C103($1; _O_Mac to Win:C463("Fiche n°"+<>va_Tab+[HeberGement:5]HG_FicheNuméro:3+<>va_Tab+String:C10(Table:C252(->[HeberGement:5]))+<>va_Tab+String:C10(Field:C253(->[HeberGement:5]HG_FicheNuméro:3))+<>va_CR))
	SEND PACKET:C103($1; _O_Mac to Win:C463("Clé"+<>va_Tab+va_FullHB_Clé+<>va_Tab+String:C10(Table:C252(->[HeberGement:5]))+<>va_Tab+String:C10(Field:C253(->[HeberGement:5]HG_HB_ID:19))+<>va_CR))
	SEND PACKET:C103($1; _O_Mac to Win:C463("Nom"+<>va_Tab+[HeBerge:4]HB_Nom:3+<>va_Tab+String:C10(Table:C252(->[HeberGement:5]))+<>va_Tab+String:C10(Field:C253(->[HeberGement:5]HG_Nom:21))+<>va_CR))
	SEND PACKET:C103($1; _O_Mac to Win:C463("Prénom"+<>va_Tab+[HeBerge:4]HB_Prénom:4+<>va_Tab+String:C10(Table:C252(->[HeberGement:5]))+<>va_Tab+String:C10(Field:C253(->[HeberGement:5]HG_Prénom:22))+<>va_CR))
	SEND PACKET:C103($1; _O_Mac to Win:C463("Né(e) le"+<>va_Tab+String:C10([HeBerge:4]HB_DateNéLe:5; Interne date court:K1:7)+<>va_Tab+String:C10(Table:C252(->[HeberGement:5]))+<>va_Tab+String:C10(Field:C253(->[HeberGement:5]HG_DateNéLe:24))+<>va_CR))
	SEND PACKET:C103($1; _O_Mac to Win:C463("Age"+<>va_Tab+String:C10([HeberGement:5]HG_Age:23; "000")+<>va_Tab+String:C10(Table:C252(->[HeberGement:5]))+<>va_Tab+String:C10(Field:C253(->[HeberGement:5]HG_Age:23))+<>va_CR))
	SEND PACKET:C103($1; _O_Mac to Win:C463("Nuit en cours"+<>va_Tab+String:C10([HeberGement:5]HG_NuitenCours:92)+<>va_Tab+String:C10(Table:C252(->[HeberGement:5]))+<>va_Tab+String:C10(Field:C253(->[HeberGement:5]HG_NuitenCours:92))+<>va_CR))
	SEND PACKET:C103($1; _O_Mac to Win:C463("Nuits totales"+<>va_Tab+String:C10([HeberGement:5]HG_NuitTOTAL:93)+<>va_Tab+String:C10(Table:C252(->[HeberGement:5]))+<>va_Tab+String:C10(Field:C253(->[HeberGement:5]HG_NuitTOTAL:93))+<>va_CR))
	SEND PACKET:C103($1; _O_Mac to Win:C463("Notes de transfert"+<>va_Tab+vt_Full_HB_Notes+<>va_Tab+String:C10(Table:C252(->[HeBerge:4]))+<>va_Tab+String:C10(Field:C253(->[HeBerge:4]HB_NotesTrans:53))+<>va_CR))
