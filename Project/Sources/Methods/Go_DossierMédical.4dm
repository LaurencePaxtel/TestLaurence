...
$T_Window_titre:="Dossier médical"  //lpc plein écran 12/10/2018
...
FORM SET INPUT:C55([DePart:1]; "DP_DosMédical")
va_Titre:="Dossier médical"
//$vl_Fenetre:=i_FenêtreNo (786;508;4;va_Titre;1;"Quit_Show")
$vl_Fenetre:=FEN_OpenFormWindow(->[DePart:1]; "DP_DosMédical"; Form fenêtre standard:K39:10; $T_Window_titre)  //lpc plein écran 12/10/2018
