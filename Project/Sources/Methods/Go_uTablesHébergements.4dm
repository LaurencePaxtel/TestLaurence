...
//{ © DBsolutions/Paxtel
//{
//{          Procédure : Go_uTablesHébergements
//{
...
$kk:=Get last field number:C255(->[HeberGement:5])
ARRAY TEXT:C222(ta_Champs; $kk)
ARRAY POINTER:C280(tp_Champs; $kk)
ARRAY INTEGER:C220(te_ChampsType; $kk)
For ($ii; 1; $kk)
	ta_Champs{$ii}:=Substring:C12(Field name:C257(Table:C252(->[HeberGement:5]); $ii); 4)
	tp_Champs{$ii}:=Field:C253(Table:C252(->[HeberGement:5]); $ii)
...
va_Titre:="Liste des hébergements : "
READ ONLY:C145([HeberGement:5])
FORM SET OUTPUT:C54([HeberGement:5]; "V_Développeur")
