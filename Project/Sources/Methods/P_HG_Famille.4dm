...
C_BOOLEAN:C305($vb_Avant2012)

$vb_Avant2012:=True:C214
...
Case of 
	...
	: ($1=3)
		...
		If ([HeberGement:5]HG_FamCompoVar:117>"")
			...
			If (Num:C11(Substring:C12([HeberGement:5]HG_FamCompoVar:117; 16; 1))>0)
				...
				[HeberGement:5]HG_FamCompo:105:=String:C10(Num:C11(Substring:C12([HeberGement:5]HG_FamCompoVar:117; 164; 1)))+"PM"
			End if 
	...
	: ($1=41)
		va_HGGP_FamCompoVar:=""
		va_HGGP_FamCompoVar:="H"+String:C10(ve_FamH)
		va_HGGP_FamCompoVar:=va_HGGP_FamCompoVar+"F"+String:C10(ve_FamF)
		va_HGGP_FamCompoVar:=va_HGGP_FamCompoVar+"B"+String:C10(ve_FamFe)
		va_HGGP_FamCompoVar:=va_HGGP_FamCompoVar+"e"+String:C10(ve_FamEMi; "00")
		va_HGGP_FamCompoVar:=va_HGGP_FamCompoVar+"E"+String:C10(ve_FamEMa; "00")
		va_HGGP_FamCompoVar:=va_HGGP_FamCompoVar+"p"+String:C10(ve_FamPMi)
		va_HGGP_FamCompoVar:=va_HGGP_FamCompoVar+"P"+String:C10(ve_FamPMa)
		
		vl_HGGP_FamNbP:=ve_FamH+ve_FamF+ve_FamFe+ve_FamEMi+ve_FamEMa+ve_FamPMi+ve_FamPMa
		
		va_HGGP_FamCompo:=""
		
		If (ve_FamH>0)
			va_HGGP_FamCompo:=String:C10(ve_FamH)+"H"
		End if 
		...
		If (ve_FamF>0)
			...
			va_HGGP_FamCompo:=va_HGGP_FamCompo+String:C10(ve_FamF)+"F"
		End if 
		...
		If (ve_FamFe>0)
			...
			va_HGGP_FamCompo:=va_HGGP_FamCompo+String:C10(ve_FamFe)+"Fe"
		End if 
