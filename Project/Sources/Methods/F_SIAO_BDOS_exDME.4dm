			...
			Repeat 
				...
				If (Records in selection:C76([HeberGement:5])>0)
					...
					Repeat 
						...
						<>vt_BDOS_VALEUR:=<>vt_BDOS_VALEUR+F_Chaine("DateSIAO"; ->[SIAO:50]Si_Trans_Date:36)+va_SepCHAMP
						<>vt_BDOS_VALEUR:=<>vt_BDOS_VALEUR+F_Chaine("TypeSIAO"; ->[SIAO:50]Si_Trans_Type:34)+va_SepCHAMP
						<>vt_BDOS_VALEUR:=<>vt_BDOS_VALEUR+[HeberGement:5]HG_Type_Prescripteur:166+va_SepCHAMP
						<>vt_BDOS_VALEUR:=<>vt_BDOS_VALEUR+F_Chaine("TypeAdmission"; ->[HeberGement:5]HG_Signalement:12)+va_SepCHAMP  //ADMISSION DIRECTE
						<>vt_BDOS_VALEUR:=<>vt_BDOS_VALEUR+F_Chaine("TypeCentre"; ->[HeberGement:5]HG_CentreNom:62)+va_SepCHAMP
						<>vt_BDOS_VALEUR:=<>vt_BDOS_VALEUR+F_Chaine("BoolAlphaSIAO"; ->[HeberGement:5]HG_Flag_Souhait:160)+va_SepFICHE
						SEND PACKET:C103($vh_RefDoc; _O_Mac to Win:C463(<>vt_BDOS_VALEUR))
