...
va_Titre:="Liste des Demandes : "
READ ONLY:C145([TablesDemande:17])
FORM SET OUTPUT:C54([TablesDemande:17]; "V_Développeur")
ALL RECORDS:C47([TablesDemande:17])
MultiSoc_Filter(->[TablesDemande:17])
vL_Nb_HG_F:=Records in selection:C76([TablesDemande:17])
FIRST RECORD:C50([TablesDemande:17])
If (<>vl_EcranL>(771+15))
	$vl_EcranL:=(771+15)
Else 
...
DISPLAY SELECTION:C59([TablesDemande:17]; *)
