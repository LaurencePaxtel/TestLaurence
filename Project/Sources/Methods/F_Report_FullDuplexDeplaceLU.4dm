...
//{ © DBsolutions
//{
//{          Procédure : F_Report_FullDuplexDeplaceLU
//{
...
Else 
	...
	$vt_LeRepLu:=<>vt_T_CheminRép+<>va_Rép_TransReportLU+Séparateur dossier:K24:12
	$vb_OK:=F_Report_FullDuplexDossier(12; $vt_LeRepLu)
	
	//• On teste l'existence dans dossier lu du dossier site
	If ($vb_OK)
		$va_Temp:=Substring:C12($2; 1; 3)
		If ($va_Temp[[3]]=" ")
			$va_Temp:=Substring:C12($va_Temp; 1; 2)
		End if 
		$vt_LeRepLu:=$vt_LeRepLu+$va_Temp+Séparateur dossier:K24:12
		$vb_OK:=F_Report_FullDuplexDossier(12; $vt_LeRepLu)
	End if 
