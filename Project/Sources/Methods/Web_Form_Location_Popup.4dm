...
// Date and time: 17-12-18, 18:20:24
// ----------------------------------------------------
// Method: Web_Form_Location_Popup
// Description
// 
//
// Parameters
...
$html:=$html+"<li class=\"\"><a href=\"#tab-2\" data-toggle=\"tab\">Documents</a></li>"
...
$html:=$html+"<div class=\"col100\">"
$html:=$html+"<div class=\"fdp_line\">"
$html:=$html+Web_Doc_Form(->[Locations:84]ID:1)
$html:=$html+"</div>"
$html:=$html+"</div>"
$html:=$html+"</div>"
$html:=$html+"</div>"
