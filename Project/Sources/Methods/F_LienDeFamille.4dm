...
// Date et heure : 22/09/21, 10:54:56
// ----------------------------------------------------
// Méthode : F_LienDeFamille
// Description
// 
//
// Paramètres
...
Case of 
	: ($1="Nouveau")
		...
		Case of 
			...
			: (User in group:C338(Current user:C182; "RemiseZeroNumerotation")=True:C214)
				CONFIRM:C162("Voulez-vous remettre à 0 la numérotation des chefs de famille ?"; "Oui"; "Non")
				$0:=$structure_t+String:C10(outilsHebergeGenKeyLinkFam((OK=1); False:C215; 0))
			Else 
