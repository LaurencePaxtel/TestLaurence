...
// Date and time: 20/05/29, 16:01:15
// ----------------------------------------------------
// Method: Web_Form_GL_Filtres_EQU
// Description
// 
//
// Parameters
...
$TB_FORM{0}{1}:="GL?action=equipements"
$TB_FORM{0}{2}:="POST"
$TB_FORM{0}{3}:="equipements"
$TB_FORM{0}{4}:=""
$TB_FORM{0}{5}:="equipements"
$TB_FORM{0}{6}:=""
...
$TB_HTML{$o}{7}:="fdp_span3  span7 iw_cg_width_quarte search iw_data_column_0 "
...
$TB_HTML{$o}{7}:="span7 search fdp_placeholder iw_cg_width_quarte iw_data_column_1"
...
Else 
	...
	$TB_HTML{$o}{7}:="fdp_span3 search span7 iw_cg_width_quarte iw_data_column_4 "
	...
	$TB_HTML{$o}{7}:="fdp_span3  search span7 iw_cg_width_quarte  iw_data_column_5 "
	
	$o:=$o+1
	$TB_HTML{$o}{1}:="input"
	$TB_HTML{$o}{2}:="hidden"
	$TB_HTML{$o}{3}:="search_filtre_4_id"
	$TB_HTML{$o}{4}:=""
	$TB_HTML{$o}{5}:=""
	$TB_HTML{$o}{6}:="search_filtre_4_id"
	$TB_HTML{$o}{7}:=""
	
	$o:=$o+1
	$TB_HTML{$o}{1}:="input"
	$TB_HTML{$o}{2}:="hidden"
	$TB_HTML{$o}{3}:="search_filtre_5_id"
	$TB_HTML{$o}{4}:=""
	$TB_HTML{$o}{5}:=""
	$TB_HTML{$o}{6}:="search_filtre_5_id"
	$TB_HTML{$o}{7}:=""
