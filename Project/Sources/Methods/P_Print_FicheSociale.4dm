...
//{ © DBsolutions/Paxtel
//{
//{          Procédure : P_Print_FicheSociale
//{
...
_O_PAGE SETUP:C299([DePart:1]; "DP_Stat_FSoc1")
PRINT SETTINGS:C106
...
If (Records in selection:C76([DePart:1])>0)
	...
	FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_FSoc1")
	PRINT SELECTION:C60([DePart:1]; *)
	FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_FSoc2")
	PRINT SELECTION:C60([DePart:1]; *)
	FORM SET OUTPUT:C54([DePart:1]; "DP_Stat_FSoc3")
	PRINT SELECTION:C60([DePart:1]; *)
