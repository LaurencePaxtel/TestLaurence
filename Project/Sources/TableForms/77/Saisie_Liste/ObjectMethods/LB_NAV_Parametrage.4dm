...
// Date et heure : 05/07/18, 11:50:26
// ----------------------------------------------------
// Méthode : LB_NAV_Parametrage
// Description
// 
//
// Paramètres
...
Case of 
	: (Form event code:C388=Sur double clic:K2:5)
		...
		GOTO SELECTED RECORD:C245([NAV_Menus:77]; ligne)
		LOAD RECORD:C52([NAV_Menus:77])
		...
		MODIFY RECORD:C57([NAV_Menus:77])
			...
			If (ligne#0)
				...
				If ($a=1)
					...
					If (ok=1)
						...
						DELETE RECORD:C58([NAV_Menus:77])
