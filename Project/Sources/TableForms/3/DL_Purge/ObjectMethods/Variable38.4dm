...
If ([HeBerge:4]HB_ReferenceID:1>0)
	...
	$vl_SIAO:=Records in selection:C76([SIAO_Personnes:51])
	If ($vl_SIAO>0)
		CREATE SET:C116([SIAO_Personnes:51]; "E_SIAOPE")
	End if 
	
	CONFIRM:C162([HeBerge:4]HB_Clé:2+Char:C90(13)+(("+ "+String:C10(vL_Nb_HB_F)+" fiche(s) d'hébergement"+Char:C90(13))*Num:C11(vL_Nb_HB_F>0))+(("+ "+String:C10($vl_SIAO)+" fiche(s) SIAO personne"+Char:C90(13))*Num:C11($vl_SIAO>0))+"Confirmez-vous la suppression ?")
