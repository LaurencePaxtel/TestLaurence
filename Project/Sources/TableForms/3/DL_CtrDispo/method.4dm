	...
	: ($vl_eventFF=Sur données modifiées:K2:15)
		...
		If (FORM Get current page:C276=1)
			...
			If (Modified:C32([CentresLits:16]CL_DispoDuJour:12) | Modified:C32([CentresLits:16]CL_Absents:13))
				[CentresLits:16]CL_DispoTotal:5:=[CentresLits:16]CL_DispoTotal:5+[CentresLits:16]CL_DispoDuJour:12  // on peut passer [CentresLits]CL_DispoDuJour en positif ou en négatif // #20170705-1
				[CentresLits:16]CL_Restant:7:=[CentresLits:16]CL_Restant:7+[CentresLits:16]CL_DispoDuJour:12  // #20170705-1
			End if 
			...
			If (Modified:C32([CentresLits:16]CL_DispoDuJour:12) | Modified:C32([CentresLits:16]CL_RestantsVeille:16) | Modified:C32([CentresLits:16]CL_Distribué:6))
				...
				Case of 
					: (Modified:C32([CentresLits:16]CL_DispoDuJour:12))
						[CentresLits:16]CL_DispoTotal:5:=[CentresLits:16]CL_DispoTotal:5+[CentresLits:16]CL_DispoDuJour:12  // #20170705-1
