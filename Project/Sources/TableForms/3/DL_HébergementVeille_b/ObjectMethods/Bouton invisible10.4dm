...
Case of 
	: (Form event code:C388=Sur clic:K2:4)
		CONFIRM:C162("Voulez-vous vraiment ne plus appliquer de filtre « Autres critères » ?"; "Oui"; "Non")
		
		If (OK=1)
			outilsHGListBoxClearAtrsCrts(-><>te_VeilEtCiv; -><>te_VeilGroupe; -><>te_VeilPerma; -><>te_VeilSglt; -><>te_VeilAutreSol; -><>te_VeilOrient1; -><>te_VeilTBOr1suite; -><>te_VeilAtSsuite; -><>te_VeilOrient2; -><>te_VeilRupMaj1; -><>te_VeilRupMaj2; \
