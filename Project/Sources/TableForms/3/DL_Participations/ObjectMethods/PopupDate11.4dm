Case of 
	...
	: (Form event code:C388=Sur données modifiées:K2:15)
		...
		If (Bool:C1537(Form:C1466.loadForm)=True:C214)
			Form:C1466.apl["decembre"].dateReception:=OBJECT Get pointer:C1124(Objet courant:K67:2)->
		End if 
		
		If (Bool:C1537(Form:C1466.loadForm)=False:C215)
			Form:C1466.loadForm:=True:C214
		End if 
