	...
	: ($vl_EventFF=Sur clic:K2:4)
		...
		If ((vl_SourisX>6) & (vl_SourisX<764)) & ((vl_SourisY>120) & (vl_SourisY<282))
			If ([HeberGement:5]HG_ReferenceID:1>0)
				...
				If (7=8)  //15/2/2010
					If ([HeberGement:5]HG_FamGroupe:102>"") & ([HeberGement:5]HG_FamChef:103)
						OBJECT SET ENABLED:C1123(b_VoirTexte; True:C214)
					Else 
				...
				Else 
					OBJECT SET ENABLED:C1123(b_VoirTexte; True:C214)
				End if 
				OBJECT SET ENABLED:C1123(b_VoirTextef; True:C214)
