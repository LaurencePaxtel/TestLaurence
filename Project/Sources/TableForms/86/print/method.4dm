...
Case of 
	: (Section="Corps")
		...
		//-----------------------------------------------------------------------------------------------
		$designation:=->[Factures_Lignes:87]FACL_Titre:6
	...
	: (Section="Entete")
		...
		Print_Resize_Image(->strc_logo; 560)
		
		SOC_Get_Config
		
		If (SO_FAC_GI_Separer_Charges)
			OBJECT SET VISIBLE:C603(txt_lig_charges; False:C215)
			OBJECT SET VISIBLE:C603(txt_lig_charges_montant; False:C215)
		End if 
