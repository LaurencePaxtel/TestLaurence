If (Form event code:C388=Sur chargement:K2:1) | (Form event code:C388=Sur données modifiées:K2:15)
	...
	If (Position:C15("/"; [HeberGement:5]HG_Maraude1_2:97)=0)
		[HeberGement:5]HG_Maraude1_2:97:=outilsStringToDate([HeberGement:5]HG_Maraude1_2:97)
	...
	If (Form event code:C388=Sur données modifiées:K2:15)
		...
		If (outilsRegexValidate(2; [HeberGement:5]HG_Maraude1_2:97)=False:C215)
