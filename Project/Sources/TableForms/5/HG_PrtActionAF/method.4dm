...
Case of 
	: (Form event code:C388=Sur chargement:K2:1) | (Form event code:C388=Sur impression corps:K2:18)
		$table_o:=ds:C1482.PARAM.query("type = :1 AND valeur = :2 AND structureRef = :3"; "*IMPRESSION"; "Impression Rapport"; <>ref_soc_active)
	...
	: (Form event code:C388=Sur impression pied de page:K2:20)
		ve_NoPage:=ve_NoPage+1
End case 