...
$P_Pop:=OBJECT Get pointer:C1124(Objet nommé:K67:5; "pop_statut")
...
Case of 
	: (Form event code:C388=Sur données modifiées:K2:15)
		...
		C_TEXT:C284($T_Label)
		GET LIST ITEM:C378(*; "pop_statut"; *; $L_Ref; $T_Label)
		
		[APPOINTMENTS:73]Statut:13:=$L_Ref
		SAVE RECORD:C53([APPOINTMENTS:73])
		
	: (Form event code:C388=Sur chargement:K2:1)
		
		
		VARIABLE TO VARIABLE:C635(Current process:C322; $P_Pop->; L_Liste_resultat)
		
		SELECT LIST ITEMS BY REFERENCE:C630($P_Pop->; [APPOINTMENTS:73]Statut:13)
