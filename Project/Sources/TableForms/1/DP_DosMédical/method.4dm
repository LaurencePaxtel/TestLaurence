...
Case of 
	: ($vl_eventFF=Sur chargement:K2:1)
		...
		vL_Nb_HG_F:=0
		va_Nb_HG_F:=""
		REDUCE SELECTION:C351([DossierMedical:29]; 0)
		vL_Nb_MR_F:=0
		va_Nb_MR_F:=""
	...
	: ($vl_eventFF=Sur clic:K2:4)
		...
		If ((vl_SourisX>290) & (vl_SourisX<764)) & ((vl_SourisY>54) & (vl_SourisY<188))
			...
			If ([HeBerge:4]HB_ReferenceID:1>0)
				...
				vl_Nb_MR_F:=Records in selection:C76([DossierMedical:29])
				ORDER BY:C49([DossierMedical:29]; [DossierMedical:29]DM_Date:4; <; *)
				ORDER BY:C49([DossierMedical:29]; [DossierMedical:29]DM_Heure:5; <)
