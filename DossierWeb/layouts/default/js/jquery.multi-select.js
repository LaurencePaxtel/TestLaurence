    ...
    'init' : function(options){
      ...
      return multiSelects.each(function(){
        ...
        if (ms.next('.ms-container').length == 0){
		  ...
		  if((ms.attr('class')).search('multiselectrecherche') !== -1) {   var classOrigine = 'cssmultiselectrecherche';}else{  var classOrigine = 'cssmultiselect';}
          var container = $('<div id="ms-'+ms.attr('id')+'" class="'+classOrigine+' ms-container"></div>'),
              selectableContainer = $('<div class="ms-selectable"><span id="iw_selectable_list_title" style="display:none;"></div>'),
              selectedContainer = $('<div class="ms-selection"><span id="iw_selected_list_title" style="display:none;"></span></div>'),
