...
(function (h, n, m, f, p) {
    ...
    (function (b, c, a) {
        ...
        e.display.envelope = a.extend(!0, {}, e.models.displayController, {
            ...
            _show: function (b) {
                ...
                c.display = "none";
                c.opacity = 1;
                d._dom.wrapper.style.width = o + "px";
    ...
    e.prototype.add = function (b) {
        ...
        else b = f.extend(!0, {}, e.models.field, b), b.id = "DTE_Field_" + b.name, "" === b.dataProp && (b.dataProp = b.name), b.dataSourceGet = function () {
    ...
    e.prototype.enable = function (b) {
        if (f.isArray(b)) for (var c = 0, a = b.length; c < a; c++) this.enable(b[c]);
    ...
    e.prototype.field = function (b) {
        ...
        f.each(i, function (b, f) {
            a[b] = "function" === typeof f ? function () {
    ...
    e.prototype._callbackReg = function (b, c, a) {
    ...
    }), h.TableTools.BUTTONS.editor_projet= f.extend(!0, h.TableTools.BUTTONS.select_single, {
        sButtonText: "Projet Button",
        editor: null,
        formTitle: "Edit Projet",
        formButtons: [{
            label: "Générer le Rapport de Projet",
            fn: function () {
    ...
    }), h.TableTools.BUTTONS.editor_operation = f.extend(!0, h.TableTools.BUTTONS.select_single, {
        sButtonText: "Visualiser",
        editor: null,
        formTitle: "Fiche d'operation",
        formButtons: [{
            label: "Générer le Rapport d'operation",
            fn: function () {

            },
        },
		{
            label: "Générer le Rapport PROG",
            fn: function () {
